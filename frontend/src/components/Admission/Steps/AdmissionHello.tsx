...
const AdmissionHello = () => {
  ...
  return (
    <div className=''>
      <h2 className='text-3xl max-2xl:text-2xl mb-2 font-medium'>
        Добро пожаловать на приемную кампанию!
      </h2>
      <div className='text-lg'>
        <h5>
          Дорогие родители и будущие первоклассники! Мы рады приветствовать вас на приемной кампании
          в нашу начальную школу! На этом этапе мы ознакомим вас с основными шагами приемной
          кампании.
        </h5>
        <br />
        <ul className='list-decimal ml-5'>
          <li className='my-1'>
            <span className='font-semibold'>Первичные документы:</span> Пожалуйста, предоставьте все
            необходимые первичные документы, такие как свидетельство о рождении ребенка и документы
            родителей.
          </li>
          <li className='my-1'>
